...
function openAppNativeView(viewName){
    ...
    console.log("openAppNativeView");
} 
//打开新页面
function openAppNewPage(pageUrl){
   
    console.log("openAppNewPage");
} 
//关闭页面
function closeAppPage(){
    console.log("closeAppPage");
    
}

//打开第三方，加顶部返回及标题
function openAppNewPageWithToolBar(pageUrl){
    console.log("openAppNewPageWithToolBar");
...
function checkUserLoginFromApp(){
    ...
    console.log("checkUserLoginFromApp");
}
...
function getSignParamFromApp(obj){
    ...
    console.log("getSignParamFromApp");
    ...
    dataDict.sign = autoSign(dataDict);

    var str = JSON.stringify(dataDict);
  ...
  var WebViewJavascriptBridge = {
    getSignParam:function(){
        console.log("WebViewJavascriptBridge.getSignParam()");
        
        return getSignParamFromApp();
    },
  ...
  var JxhAndroid = {
    getSignParam: function(sendStr){
        console.log(" window.JxhAndroid.getSignParam");
        return getSignParamFromApp();
    },
    checkUserLogin:function(){
        return true;
