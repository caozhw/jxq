<template>
  <div class="container">
    ...
    <div class="content">
      ...
      <h2>选择充值金币</h2>
      <div class="select">
        <div v-for="(item,index) in coinList" :class="selectCoinIndex==index?'select-item active':'select-item'" @click="handleSelectCoinClick(item,index)">
      ...
      <p class="treaty"><span>点击充值即表示你已同意</span><a href="#" @click="handleTreatyClick">《充值协议》</a></p>
...
import {sendRequest_app, getSignParamFromApp, openAppNativeView, goBackPage,controlTime,showLogDialogApp,clearWebCacheApp,reloadWebViewApp,cpJsonToForm} from '@/axios/axios_vue';
